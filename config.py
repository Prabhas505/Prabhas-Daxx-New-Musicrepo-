...
BOT_USERNAME = getenv("BOT_USERNAME", "MayraMusic_Bot")
BOT_NAME = getenv("BOT_NAME", "˹Mayra ✘ Music˼ ♪")
ASSUSERNAME = getenv("ASSUSERNAME", "MayraXMusic")
EVALOP = list(map(int, getenv("EVALOP", "6797202080").split()))
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOGGER_ID = int(getenv("LOGGER_ID", -1002044553210))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Prabhas505/Prabhas-Daxx-New-Musicrepo-")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/a5c3c6fb09bdb7d3e2153.mp4"
)
PING_VID_URL = getenv(
    "PING_VID_URL", "https://graph.org/file/a5c3c6fb09bdb7d3e2153.mp4"
)
PLAYLIST_IMG_URL = "https://telegra.ph/file/94e9eca3b0ec6e2dc6cd5.png"
STATS_VID_URL = "https://graph.org/file/a5c3c6fb09bdb7d3e2153.mp4"
